...
void WareHouse_Draw() {
	...
	DrawStringToHandle(550,250, "E:終了", GetColor(255, 255, 255),Font01);
	DrawStringToHandle(550, 400, "装備情報", GetColor(255, 255, 255),Font01);
	//s = "キャラクタ管理部の関数";
	DrawFormatStringToHandle(550, 490, GetColor(255, 255, 255),Font01,"装備中:%s atk:%d hp:%d", itemRef[player_item.equipment.ID].name, player_item.equipment.atk, player_item.equipment.hp);
